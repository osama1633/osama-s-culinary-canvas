...
if (typeof window !== "undefined") {
  ...
  style.innerHTML = `
    [id^="lovable-"], .lovable-badge, #lovable-badge, [class*="lovable"], button[data-lovable="true"] {
  ...
  head: () => ({
    meta: [
      { title: "Osama's Kitchen — Where Every Bite Tells A Story" },
      {
        name: "description",
        content:
          "Luxury burgers, wood-fired pizza, fried chicken, sandwiches & desserts — handcrafted by Osama's Kitchen and delivered fresh.",
      },
      { property: "og:title", content: "Osama's Kitchen — Where Every Bite Tells A Story" },
      {
        property: "og:description",
        content:
          "Luxury burgers, wood-fired pizza, fried chicken, sandwiches & desserts — handcrafted and delivered fresh.",
      },
...
const DISHES: Dish[] = [
  {
    name: "The Osama Signature",
    desc: "Double wagyu patty, aged cheddar, smoked aioli, brioche.",
    price: "$18",
    rating: 5.0,
    img: heroBurger,
    category: "Burgers",
  ...
  {
    name: "Truffle Stack",
    desc: "Black truffle butter, gruyère, caramelized shallots.",
    price: "$22",
    rating: 4.9,
    img: dishBurger2,
    category: "Burgers",
  ...
  {
    name: "Napoli D.O.P.",
    desc: "San Marzano, fior di latte, wood-fired 90 seconds.",
    price: "$16",
    rating: 4.9,
    img: dishPizza,
    category: "Pizza",
  ...
  {
    name: "Crispy Gold Tenders",
    desc: "Buttermilk-brined, double-dredged, honey gold drizzle.",
    price: "$14",
    rating: 4.8,
    img: dishChicken,
  ...
  {
    name: "Smoked Club Tower",
    desc: "Bacon, heirloom tomato, aged cheddar, garlic aioli.",
    price: "$13",
    rating: 4.7,
    img: dishSandwich,
    category: "Sandwiches",
  },
  {
    ...
    desc: "Dark chocolate lava, vanilla bean, 24k gold leaf.",
    price: "$11",
    rating: 5.0,
    img: dishDessert,
    category: "Desserts",
  ...
  },
  {
    ...
    desc: "48-hour cold extraction with vanilla cream swirl.",
    price: "$7",
    rating: 4.8,
    img: dishDrink,
    category: "Drinks",
  ...
  {
    name: "Bourbon BBQ Burger",
    desc: "Bourbon glaze, crispy onions, smoked bacon.",
    price: "$17",
    rating: 4.8,
    img: heroBurger,
    category: "Burgers",
  },
  {
    ...
    desc: "Four artisan cheeses, hot honey, fresh thyme.",
    price: "$18",
    rating: 4.8,
    img: dishPizza,
    category: "Pizza",
  ...
  {
    name: "Nashville Hot",
    desc: "Cayenne-glazed, pickled cucumber, soft milk bun.",
    price: "$15",
    rating: 4.9,
    img: dishChicken,
    category: "Fried Chicken",
  ...
  {
    name: "Steak & Onion Melt",
    desc: "Slow-braised short rib, provolone, jus dip.",
    price: "$16",
    rating: 4.7,
    img: dishSandwich,
    category: "Sandwiches",
  ...
  {
    name: "Saffron Iced Latte",
    desc: "Persian saffron syrup, milk foam art.",
    price: "$8",
    rating: 4.7,
    img: dishDrink,
    category: "Drinks",
    ...
    <div className="flex items-center gap-2.5 select-none">
      ...
      <div className={`font-display ${s} leading-none`}>
        <span className="block tracking-wider">
          OSAMA<span className="text-gradient-gold">'S</span>
        </span>
        <span className="block text-[0.55em] tracking-[0.45em] text-muted-foreground mt-1">
          KITCHEN
        </span>
      </div>
    </div>
  ...
  return (
    <section ref={ref} id="home" className="relative min-h-[100svh] overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div
          className="absolute bottom-1/3 right-[10%] h-16 w-16 rounded-full bg-ember/10 blur-xl animate-float"
      ...
      >
        ...
        >
          Experience unforgettable flavors crafted with passion and delivered fresh to your
          doorstep.
        </motion.p>
        ...
        >
          ...
          <div className="relative h-10 w-5 rounded-full border border-border">
            <span
              className="absolute left-1/2 top-1.5 -translate-x-1/2 h-1.5 w-1 rounded-full bg-gold"
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <motion.div layout className="mt-12 grid gap-6 md:gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <AnimatePresence mode="popLayout">
            {filtered.map((d, i) => (
              <DishCard key={d.name + cat} d={d} idx={i} />
            ))}
          </AnimatePresence>
        </motion.div>
      </div>
  ...
  const items = [
    {
      ...
      desc: "Sourced daily from local farms and trusted producers.",
    },
    {
      icon: Truck,
      title: "Fast Delivery",
      desc: "Hot and pristine at your door in under 30 minutes.",
    },
    {
      icon: ChefHat,
      title: "Expert Chefs",
      desc: "Trained in Michelin-star kitchens across three continents.",
    },
    {
      icon: Award,
      title: "Best Quality",
      desc: "Every plate inspected — nothing leaves unless it's perfect.",
    },
    {
      icon: Sparkles,
      title: "Affordable Luxury",
      desc: "Fine-dining craft without the white-tablecloth price tag.",
    },
  ];
  return (
        ...
        <div className="relative overflow-hidden rounded-[2.5rem] glass-strong">
          <div className="grid lg:grid-cols-2">
            <div className="relative aspect-[4/5] lg:aspect-auto">
              <img
                src={chefImg}
                alt="Chef Osama plating in the kitchen"
                loading="lazy"
            ...
            <div className="relative p-8 md:p-14 flex flex-col justify-center">
              ...
              <p className="mt-5 max-w-md text-muted-foreground leading-relaxed">
                Twelve years of fire, smoke and obsession reduced into a single plate. Tonight's
                spotlight: the Truffle Stack — aged gruyère, black truffle butter, brioche kissed by
                the flat-top.
              </p>
              <div className="mt-8 flex items-center gap-3">
                <a
                  href={waLink("Truffle Stack", "$22")}
                  target="_blank"
                  rel="noreferrer"
...
const REVIEWS = [
  {
    ...
    text: "Truly the best burger in the city. The Truffle Stack ruined every other burger for me — I mean that as a compliment.",
    rating: 5,
  },
  {
    name: "Marcus Reyes",
    role: "Verified Customer",
    text: "Delivery was 22 minutes and the pizza was still crackling. Whatever Osama is doing, he should never stop.",
    rating: 5,
  },
  {
    name: "Sara Mansour",
    role: "Verified Customer",
    text: "The molten gold cake is the most photographed dessert on my Instagram. Worth every bite, every dollar.",
    rating: 5,
  },
  {
    name: "Omar Khalil",
    role: "Verified Customer",
    text: "Five years of ordering from Osama's. Quality has never dipped once. That is rare and it should be celebrated.",
    rating: 5,
  },
];
function Reviews() {
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="mt-8 flex items-center justify-center gap-3">
                  <div className="grid h-12 w-12 place-items-center rounded-full bg-gradient-gold font-display text-ink">
                    {r.name[0]}
                  </div>
                  <div className="text-left">
                    <div className="font-medium flex items-center gap-1.5">
                      {r.name}
                      <span
                        className="inline-grid h-4 w-4 place-items-center rounded-full bg-gold/20"
                        title="Verified"
                      >
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 auto-rows-[180px] md:auto-rows-[220px] gap-3 md:gap-4">
          {imgs.map((im, i) => (
            ...
            >
              ...
              <div className="absolute bottom-3 left-3 text-xs text-foreground/0 group-hover:text-foreground transition-colors">
                View
              </div>
            </motion.button>
          ))}
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            ...
            <button
              onClick={() => setOpen(null)}
              className="absolute top-6 right-6 grid h-12 w-12 place-items-center rounded-full glass-strong"
            >
              <X className="h-5 w-5" />
            </button>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center relative">
            <div>
              ...
              <p className="mt-5 text-muted-foreground leading-relaxed">
                Private dining, anniversaries, quiet evenings — leave the details to us. We confirm
                every reservation within the hour.
              </p>
            ...
            >
              ...
              <Field label="Phone">
                <input required type="tel" className="field" placeholder="+20 ..." />
              </Field>
              <Field label="Note">
                <textarea
                  rows={3}
...
function Contact() {
  const items = [
    ...
    { icon: MessageCircle, label: "WhatsApp", value: "01221996350", href: `https://wa.me/${WA}` },
    {
      icon: Mail,
      label: "Email",
      value: "osamafares8070@gmail.com",
      href: "mailto:osamafares8070@gmail.com",
    },
    ...
    <section id="contact" className="relative py-24">
      <div className="mx-auto max-w-7xl px-6">
        <SectionHead
          ...
          title="Say"
          accent="Hello"
          sub="Hungry, curious, or just want to chat — we're a message away."
        />
        ...
        <div className="grid gap-12 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
          <div>
            ...
            <p className="mt-5 max-w-xs text-sm text-muted-foreground leading-relaxed">
              A luxury kitchen for everyday occasions. Crafted in small batches, plated with
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              New drops, secret menus, chef's picks — once a month.
            </p>
            <form
            ...
            >
              ...
              />
              <button
                className="grid h-10 w-10 place-items-center rounded-full bg-gradient-gold text-ink shadow-gold"
